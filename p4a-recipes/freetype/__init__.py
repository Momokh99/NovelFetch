...
class FreetypeRecipe(Recipe):
    """Override of the freetype recipe using SourceForge mirror.

    The upstream Savannah GNU CDN (download.savannah.gnu.org) is unreliable
    and frequently returns 502/504 errors on GitHub Actions runners.
    This override uses SourceForge as a fallback mirror.
    """
